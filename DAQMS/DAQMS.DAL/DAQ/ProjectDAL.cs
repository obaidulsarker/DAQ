...
namespace DAQMS.DAL
{
    public class ProjectDAL : DataAccessBase<ProjectViewModel>
    {
        ...
        {
            return GetObjList(item.Id, item.CompanyId, item.ProjectName, item.ProjectStatusId, item.LoginUserID, 0, 1).FirstOrDefault();
        }
    }
}
