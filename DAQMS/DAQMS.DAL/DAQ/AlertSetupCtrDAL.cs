    ...
    public class AlertSetupCtrDAL : DataAccessBase<AlertSetupCTRViewModel>
    {
        ...
        public override System.Int32 Save(AlertSetupCTRViewModel item, string mood)
        {
            ...
            try
            {
                ...
                command.Parameters.Add(new NpgsqlParameter("p_ctr", NpgsqlDbType.Varchar));
                command.Parameters[2].Value = item.CTR;
        ...
        {
            return GetObjList(item.Id, item.AlertSetupId, item.LoginUserID, 0, 1).FirstOrDefault();
        }
    }
}
