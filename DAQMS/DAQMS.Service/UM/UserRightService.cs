...
namespace DAQMS.Service
{
    public class UserRightService : BusinessBase<UserRightViewModel>
    {
        ...
        {
            return UserRightDAL.GetInstance().GetObjList(item, 0, 10000000);
        }
        ...
        {
            return UserRightDAL.GetInstance().GetObjList(0, user.Id, user.LoginID, 0, 10000000);
        }
        ...
        public override List<UserRightViewModel> GetAll()
        {
            ...
            return obj.GetObjList(new UserRightViewModel(), 0, 100000000);
        }
