...
namespace DAQMS.Service
{
    public class ContactService : BusinessBase<ContactViewModel>
    {
        ...
        {
            return ContactDAL.GetInstance().GetObjList(item, 0, 10000000);
        }
